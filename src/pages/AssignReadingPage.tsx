...
import { ChevronRight, ShoppingBag, BookOpen, Search, Star, Flame, Eye, Plus, X } from 'lucide-react'
...
const mockResources: ReadingResource[] = [
  { id: 'r01', title: '中国空间站将迎首位外籍航天员 / 精读讲解', duration: '20min', difficulty: 3, isHot: true, date: '2026-04-30', readCountText: '0.19M', coverColor: '#4b7cf0', addedToPrep: false, addedToBasket: false },
  { id: 'r02', title: '中国空间站将迎首位外籍航天员 / 开始答题', duration: '20min', difficulty: 3, isHot: true, date: '2026-04-30', readCountText: '0.19M', coverColor: '#3dbfc4', addedToPrep: false, addedToBasket: false },
  { id: 'r03', title: '年轻人的"躺平"哲学 / 精读讲解', duration: '20min', difficulty: 2, isHot: true, date: '2026-04-17', readCountText: '0.19M', coverColor: '#5bb878', addedToPrep: false, addedToBasket: false },
  { id: 'r04', title: '年轻人的"躺平"哲学 / 开始答题', duration: '20min', difficulty: 2, isHot: true, date: '2026-04-17', readCountText: '0.19M', coverColor: '#f08c3a', addedToPrep: false, addedToBasket: false },
  { id: 'r05', title: '方便面的发明 / 精读讲解', duration: '20min', difficulty: 2, isHot: true, date: '2026-04-03', readCountText: '0.19M', coverColor: '#8b7cf0', addedToPrep: false, addedToBasket: false },
  { id: 'r06', title: '方便面的发明 / 开始答题', duration: '20min', difficulty: 2, isHot: true, date: '2026-04-03', readCountText: '0.19M', coverColor: '#e85d8b', addedToPrep: false, addedToBasket: false },
  { id: 'r07', title: '人工智能如何改变我们的沟通方式？ / 精读讲解', duration: '20min', difficulty: 2, isHot: true, date: '2026-02-13', readCountText: '0.15M', coverColor: '#6b7db3', addedToPrep: false, addedToBasket: false },
  { id: 'r08', title: '人工智能如何改变我们的沟通方式？ / 开始答题', duration: '20min', difficulty: 2, isHot: true, date: '2026-02-13', readCountText: '0.15M', coverColor: '#d97a5c', addedToPrep: false, addedToBasket: false },
]
            ...
            {filtered.map((r) => (
              <div key={r.id} className="flex gap-3 bg-white rounded-xl border border-[#e8eef4] p-3 hover:shadow-sm transition-shadow">
                ...
                >
                  ...
                  <span className="absolute bottom-1.5 left-1.5 text-[9px] text-white/80 font-medium">
                    {r.date}
                  </span>
