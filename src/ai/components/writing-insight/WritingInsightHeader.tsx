...
import type { TimeRange } from '../../insights/writingInsightTypes'
import { TIME_RANGE_LABELS } from '../../insights/writingInsightTypes'
...
export default function WritingInsightHeader({ timeRange, onTimeRangeChange, className, updatedAt }: Props) {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-bold text-slate-800 tracking-tight">写作洞察</h1>
