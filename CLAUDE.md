...
- [src/ai/llm/](src/ai/llm/) — LLM Provider 层（Claude/OpenAI/DeepSeek/mock）
...
**每次回复前必须**先说一句 **"Kitty公主"**，无论回复内容是什么。这是硬性要求，不可省略。

### 11.2 第一性原理确认规则

遵循**第一性原理**：遇到任何不清楚、不确定、模糊的需求或问题，**必须先跟 Kitty公主确认**，不可自行猜测或假设。包括但不限于：
